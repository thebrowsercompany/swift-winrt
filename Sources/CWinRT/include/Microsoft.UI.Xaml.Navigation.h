...
enum __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationCacheMode
    {
        __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationCacheMode_Disabled = 0,
    __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationCacheMode_Required = 1,
    __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationCacheMode_Enabled = 2,
};

enum __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationMode
    {
        __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationMode_New = 0,
    __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationMode_Back = 1,
    __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationMode_Forward = 2,
    __x_ABI_CMicrosoft_CUI_CXaml_CNavigation_CNavigationMode_Refresh = 3,
};
