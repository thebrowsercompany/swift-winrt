...
enum __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds
    {
        __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_None = 0,
    __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_OffscreenRendered = 0x1,
    __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_Colors = 0x2,
    __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_Effects = 0x4,
    __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_Shadows = 0x8,
    __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_Lights = 0x10,
    __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_Surfaces = 0x20,
    __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_SwapChains = 0x40,
    __x_ABI_CMicrosoft_CUI_CComposition_CDiagnostics_CCompositionDebugOverdrawContentKinds_All = 0xffffffff,
};
