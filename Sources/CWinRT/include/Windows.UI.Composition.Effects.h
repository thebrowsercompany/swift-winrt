...
enum __x_ABI_CWindows_CUI_CComposition_CEffects_CSceneLightingEffectReflectanceModel
    {
        __x_ABI_CWindows_CUI_CComposition_CEffects_CSceneLightingEffectReflectanceModel_BlinnPhong = 0,
    __x_ABI_CWindows_CUI_CComposition_CEffects_CSceneLightingEffectReflectanceModel_PhysicallyBasedBlinnPhong = 1,
};
