...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIQueryOptions: test_component.IID {
...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIQueryOptionsFactory: test_component.IID {
...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIQueryOptionsWithProviderFilter: test_component.IID {
...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIStorageFileQueryResult: test_component.IID {
...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIStorageFileQueryResult2: test_component.IID {
...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations: test_component.IID {
...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryResult: test_component.IID {
...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIStorageItemQueryResult: test_component.IID {
...
private var IID___x_ABI_CWindows_CStorage_CSearch_CIStorageQueryResultBase: test_component.IID {
...
public enum __ABI_Windows_Storage_Search {
    public class IQueryOptions: test_component.IInspectable {
        ...
        internal func get_FolderDepthImpl() throws -> test_component.FolderDepth {
            var value: __x_ABI_CWindows_CStorage_CSearch_CFolderDepth = .init(rawValue: 0)
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptions.self) { pThis in
        ...
        internal func put_FolderDepthImpl(_ value: test_component.FolderDepth) throws {
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptions.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.put_FolderDepth(pThis, .init(rawValue: value.rawValue)))
            }
        }
        ...
        internal func get_IndexerOptionImpl() throws -> test_component.IndexerOption {
            var value: __x_ABI_CWindows_CStorage_CSearch_CIndexerOption = .init(rawValue: 0)
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptions.self) { pThis in
        ...
        internal func put_IndexerOptionImpl(_ value: test_component.IndexerOption) throws {
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptions.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.put_IndexerOption(pThis, .init(rawValue: value.rawValue)))
            }
        }
        ...
        internal func get_DateStackOptionImpl() throws -> test_component.DateStackOption {
            var value: __x_ABI_CWindows_CStorage_CSearch_CDateStackOption = .init(rawValue: 0)
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptions.self) { pThis in
        ...
        internal func SetThumbnailPrefetchImpl(_ mode: test_component.ThumbnailMode, _ requestedSize: UInt32, _ options: test_component.ThumbnailOptions) throws {
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptions.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.SetThumbnailPrefetch(pThis, .init(rawValue: mode.rawValue), requestedSize, .init(rawValue: options.rawValue)))
            }
        }
        ...
        internal func SetPropertyPrefetchImpl(_ options: test_component.PropertyPrefetchOptions, _ propertiesToRetrieve: test_component.AnyIIterable<String>?) throws {
            ...
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptions.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.SetPropertyPrefetch(pThis, .init(rawValue: options.rawValue), _propertiesToRetrieve))
            }
        }
    ...
    public class IQueryOptionsFactory: test_component.IInspectable {
        ...
        internal func CreateCommonFileQueryImpl(_ query: test_component.CommonFileQuery, _ fileTypeFilter: test_component.AnyIIterable<String>?) throws -> IQueryOptions {
            let (queryOptions) = try ComPtrs.initialize { queryOptionsAbi in
                ...
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptionsFactory.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateCommonFileQuery(pThis, .init(rawValue: query.rawValue), _fileTypeFilter, &queryOptionsAbi))
                }
            }
        ...
        internal func CreateCommonFolderQueryImpl(_ query: test_component.CommonFolderQuery) throws -> IQueryOptions {
            let (queryOptions) = try ComPtrs.initialize { queryOptionsAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIQueryOptionsFactory.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateCommonFolderQuery(pThis, .init(rawValue: query.rawValue), &queryOptionsAbi))
                }
            }
            return IQueryOptions(queryOptions!)
        }
    ...
    public class IStorageFolderQueryOperations: test_component.IInspectable {
        ...
        open func GetIndexedStateAsyncImpl() throws -> test_component.AnyIAsyncOperation<test_component.IndexedState>? {
            let (operation) = try ComPtrs.initialize { operationAbi in
        ...
        open func CreateFileQueryOverloadDefaultImpl() throws -> test_component.StorageFileQueryResult? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
        ...
        open func CreateFileQueryImpl(_ query: test_component.CommonFileQuery) throws -> test_component.StorageFileQueryResult? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateFileQuery(pThis, .init(rawValue: query.rawValue), &valueAbi))
                }
            }
            return .from(abi: value)
        }

        open func CreateFileQueryWithOptionsImpl(_ queryOptions: test_component.QueryOptions?) throws -> test_component.StorageFileQueryResult? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
        ...
        open func CreateFolderQueryOverloadDefaultImpl() throws -> test_component.StorageFolderQueryResult? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
        ...
        open func CreateFolderQueryImpl(_ query: test_component.CommonFolderQuery) throws -> test_component.StorageFolderQueryResult? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.CreateFolderQuery(pThis, .init(rawValue: query.rawValue), &valueAbi))
                }
            }
            return .from(abi: value)
        }

        open func CreateFolderQueryWithOptionsImpl(_ queryOptions: test_component.QueryOptions?) throws -> test_component.StorageFolderQueryResult? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
        ...
        open func CreateItemQueryImpl() throws -> test_component.StorageItemQueryResult? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
        ...
        open func CreateItemQueryWithOptionsImpl(_ queryOptions: test_component.QueryOptions?) throws -> test_component.StorageItemQueryResult? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
        ...
        open func GetFilesAsyncImpl(_ query: test_component.CommonFileQuery, _ startIndex: UInt32, _ maxItemsToRetrieve: UInt32) throws -> test_component.AnyIAsyncOperation<test_component.AnyIVectorView<test_component.StorageFile?>?>? {
            let (operation) = try ComPtrs.initialize { operationAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.GetFilesAsync(pThis, .init(rawValue: query.rawValue), startIndex, maxItemsToRetrieve, &operationAbi))
                }
            }
            return test_component.__x_ABI_C__FIAsyncOperation_1___x_ABI_C__FIVectorView_1___x_ABI_CWindows__CStorage__CStorageFileWrapper.unwrapFrom(abi: operation)
        }

        open func GetFilesAsyncOverloadDefaultStartAndCountImpl(_ query: test_component.CommonFileQuery) throws -> test_component.AnyIAsyncOperation<test_component.AnyIVectorView<test_component.StorageFile?>?>? {
            let (operation) = try ComPtrs.initialize { operationAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.GetFilesAsyncOverloadDefaultStartAndCount(pThis, .init(rawValue: query.rawValue), &operationAbi))
                }
            }
            return test_component.__x_ABI_C__FIAsyncOperation_1___x_ABI_C__FIVectorView_1___x_ABI_CWindows__CStorage__CStorageFileWrapper.unwrapFrom(abi: operation)
        }

        open func GetFoldersAsyncImpl(_ query: test_component.CommonFolderQuery, _ startIndex: UInt32, _ maxItemsToRetrieve: UInt32) throws -> test_component.AnyIAsyncOperation<test_component.AnyIVectorView<test_component.StorageFolder?>?>? {
            let (operation) = try ComPtrs.initialize { operationAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.GetFoldersAsync(pThis, .init(rawValue: query.rawValue), startIndex, maxItemsToRetrieve, &operationAbi))
                }
            }
        ...
        open func GetFoldersAsyncOverloadDefaultStartAndCountImpl(_ query: test_component.CommonFolderQuery) throws -> test_component.AnyIAsyncOperation<test_component.AnyIVectorView<test_component.StorageFolder?>?>? {
            let (operation) = try ComPtrs.initialize { operationAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
                    try CHECKED(pThis.pointee.lpVtbl.pointee.GetFoldersAsyncOverloadDefaultStartAndCount(pThis, .init(rawValue: query.rawValue), &operationAbi))
                }
            }
            return test_component.__x_ABI_C__FIAsyncOperation_1___x_ABI_C__FIVectorView_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.unwrapFrom(abi: operation)
        }

        open func GetItemsAsyncImpl(_ startIndex: UInt32, _ maxItemsToRetrieve: UInt32) throws -> test_component.AnyIAsyncOperation<test_component.AnyIVectorView<test_component.AnyIStorageItem?>?>? {
            let (operation) = try ComPtrs.initialize { operationAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
        ...
        open func AreQueryOptionsSupportedImpl(_ queryOptions: test_component.QueryOptions?) throws -> Bool {
            var value: boolean = 0
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
        ...
        open func IsCommonFolderQuerySupportedImpl(_ query: test_component.CommonFolderQuery) throws -> Bool {
            var value: boolean = 0
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.IsCommonFolderQuerySupported(pThis, .init(rawValue: query.rawValue), &value))
            }
            return .init(from: value)
        }

        open func IsCommonFileQuerySupportedImpl(_ query: test_component.CommonFileQuery) throws -> Bool {
            var value: boolean = 0
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperations.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.IsCommonFileQuerySupported(pThis, .init(rawValue: query.rawValue), &value))
            }
            return .init(from: value)
        }
    ...
    internal static var IStorageFolderQueryOperationsVTable: __x_ABI_CWindows_CStorage_CSearch_CIStorageFolderQueryOperationsVtbl = .init(
        ...
        CreateFileQuery: {
            do {
                guard let __unwrapped__instance = IStorageFolderQueryOperationsWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
                let query: test_component.CommonFileQuery = .init(rawValue: $1.rawValue)
        ...
        CreateFolderQuery: {
            do {
                guard let __unwrapped__instance = IStorageFolderQueryOperationsWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
                let query: test_component.CommonFolderQuery = .init(rawValue: $1.rawValue)
    ...
    public class IStorageQueryResultBase: test_component.IInspectable {
        ...
        open func GetItemCountAsyncImpl() throws -> test_component.AnyIAsyncOperation<UInt32>? {
            let (operation) = try ComPtrs.initialize { operationAbi in
            ...
            return test_component.__x_ABI_C__FIAsyncOperation_1_UINT32Wrapper.unwrapFrom(abi: operation)
        }

        open func get_FolderImpl() throws -> test_component.StorageFolder? {
        ...
        open func add_ContentsChangedImpl(_ handler: TypedEventHandler<test_component.AnyIStorageQueryResultBase?, Any?>?) throws -> EventRegistrationToken {
            var eventCookie: EventRegistrationToken = .init()
            let handlerWrapper = test_component.__x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CSearch__CIStorageQueryResultBase_IInspectableWrapper(handler)
        ...
        open func add_OptionsChangedImpl(_ changedHandler: TypedEventHandler<test_component.AnyIStorageQueryResultBase?, Any?>?) throws -> EventRegistrationToken {
            var eventCookie: EventRegistrationToken = .init()
            let changedHandlerWrapper = test_component.__x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CSearch__CIStorageQueryResultBase_IInspectableWrapper(changedHandler)
        ...
        open func FindStartIndexAsyncImpl(_ value: Any?) throws -> test_component.AnyIAsyncOperation<UInt32>? {
            let (operation) = try ComPtrs.initialize { operationAbi in
        ...
        open func GetCurrentQueryOptionsImpl() throws -> test_component.QueryOptions? {
            let (value) = try ComPtrs.initialize { valueAbi in
                _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageQueryResultBase.self) { pThis in
        ...
        open func ApplyNewQueryOptionsImpl(_ newQueryOptions: test_component.QueryOptions?) throws {
            _ = try perform(as: __x_ABI_CWindows_CStorage_CSearch_CIStorageQueryResultBase.self) { pThis in
    ...
    internal static var IStorageQueryResultBaseVTable: __x_ABI_CWindows_CStorage_CSearch_CIStorageQueryResultBaseVtbl = .init(
        ...
        add_ContentsChanged: {
            guard let __unwrapped__instance = IStorageQueryResultBaseWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            guard let handler = test_component.__x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CSearch__CIStorageQueryResultBase_IInspectableWrapper.unwrapFrom(abi: ComPtr($1)) else { return E_INVALIDARG }
        ...
        add_OptionsChanged: {
            guard let __unwrapped__instance = IStorageQueryResultBaseWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            guard let changedHandler = test_component.__x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CSearch__CIStorageQueryResultBase_IInspectableWrapper.unwrapFrom(abi: ComPtr($1)) else { return E_INVALIDARG }
    ...
    public class _ABI_SortEntry {
        ...
        public init() { }
        public init(from swift: test_component.SortEntry) {
