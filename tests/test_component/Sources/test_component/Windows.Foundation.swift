...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.asyncstatus
public typealias AsyncStatus = __x_ABI_CWindows_CFoundation_CAsyncStatus
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.propertytype
public typealias PropertyType = __x_ABI_CWindows_CFoundation_CPropertyType
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.deferral
public final class Deferral : WinRTClass, IClosable {
    ...
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.deferral.close
    public func close() throws {
        try _IClosable.CloseImpl()
    }

    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.deferral.complete
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.datetime
public struct DateTime: Hashable, Codable {
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.datetime.universaltime
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.point
public struct Point: Hashable, Codable {
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.point.x
    public var x: Float = 0.0
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.point.y
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.rect
public struct Rect: Hashable, Codable {
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.rect.x
    public var x: Float = 0.0
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.rect.y
    public var y: Float = 0.0
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.rect.width
    public var width: Float = 0.0
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.rect.height
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.size
public struct Size: Hashable, Codable {
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.size.width
    public var width: Float = 0.0
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.size.height
    public var height: Float = 0.0
    public init() {}
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.timespan
public struct TimeSpan: Hashable, Codable {
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.timespan.duration
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.iasyncaction
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.iasyncinfo
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.iasyncoperationwithprogress-2
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.iasyncoperation-1
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.iclosable
...
/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue
public protocol IPropertyValue : WinRTInterface {
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getuint8
    func getUInt8() throws -> UInt8
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getint16
    func getInt16() throws -> Int16
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getuint16
    func getUInt16() throws -> UInt16
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getint32
    func getInt32() throws -> Int32
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getuint32
    func getUInt32() throws -> UInt32
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getint64
    func getInt64() throws -> Int64
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getuint64
    func getUInt64() throws -> UInt64
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getsingle
    func getSingle() throws -> Float
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getdouble
    func getDouble() throws -> Double
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getchar16
    func getChar16() throws -> Character
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getboolean
    func getBoolean() throws -> Bool
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getstring
    func getString() throws -> String
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getguid
    func getGuid() throws -> UUID
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getdatetime
    func getDateTime() throws -> test_component.DateTime
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.gettimespan
    func getTimeSpan() throws -> test_component.TimeSpan
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getpoint
    func getPoint() throws -> test_component.Point
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getsize
    func getSize() throws -> test_component.Size
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.getrect
    func getRect() throws -> test_component.Rect
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.isnumericscalar
    var isNumericScalar: Bool { get }
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ipropertyvalue.type
    var type: test_component.PropertyType { get }
}

public typealias AnyIPropertyValue = any IPropertyValue

/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ireference-1
public protocol IReference<T> : IPropertyValue {
    associatedtype T
    /// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.ireference-1.value
    var value: T { get }
}

public typealias AnyIReference<T> = any IReference<T>

/// Documentation: https://learn.microsoft.com/en-us/uwp/api/windows.foundation.istringable
