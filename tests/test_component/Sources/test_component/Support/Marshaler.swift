...
fileprivate extension IUnknownRef {
    func copyTo(_ riid: UnsafeMutablePointer<test_component.IID>?, _ ppvObj: UnsafeMutablePointer<LPVOID?>?) -> HRESULT {
...
private var IMarshalVTable: IMarshalVtbl = .init(
    QueryInterface: { pUnk, riid, ppvObject in
        ...
        return riid.withMemoryRebound(to: test_component.IID.self, capacity: 1) {
            switch $0.pointee {
            case unsafeBitCast(IID_IMarshal, to: test_component.IID.self):
