...
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_C__FIIterable_1_T: WindowsFoundation.IID = .init(
...
@_spi(WinRTInternal)
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_C__FIIterator_1_T: WindowsFoundation.IID = .init(
...
@_spi(WinRTInternal)
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_C__FIKeyValuePair_2_K_V: WindowsFoundation.IID = .init(
...
@_spi(WinRTInternal)
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_C__FIMapView_2_K_V: WindowsFoundation.IID = .init(
...
@_spi(WinRTInternal)
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_C__FIMap_2_K_V: WindowsFoundation.IID = .init(
...
@_spi(WinRTInternal)
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_C__FIObservableMap_2_K_V: WindowsFoundation.IID = .init(
...
@_spi(WinRTInternal)
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_C__FIObservableVector_1_T: WindowsFoundation.IID = .init(
...
@_spi(WinRTInternal)
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_CWindows_CFoundation_CCollections_CIPropertySet: WindowsFoundation.IID = .init(
...
@_spi(WinRTInternal)
extension __ABI_Windows_Foundation_Collections {
    private static let IID___x_ABI_C__FIVector_1_T: WindowsFoundation.IID = .init(
